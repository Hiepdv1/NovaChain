...
type DbTransactionRepository interface {
	...
	GetListTransactionByBlockHash(ctx context.Context, bID string) ([]dbchain.Transaction, error)
	...
	GetTxOutputByTxIDAndIndex(ctx context.Context, args dbchain.GetTxOutputByTxIDAndIndexParams) (dbchain.TxOutput, error)
