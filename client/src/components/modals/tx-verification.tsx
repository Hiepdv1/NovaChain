...
import { GetWalletPool } from '@/lib/db/wallet.index';
...
const VerifyTransaction = ({
  ...
  const newTransaction = useTransactionCreate();
  ...
  const onSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    newTransaction.mutate(payload, {
      ...
      onSuccess: (res) => {
        ...
        onConfirmPassword(wallet, privateKey, res.data, payload);
      },
    });
  };
        ...
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-[13px] leading-relaxed">
              Please confirm your password to complete this transaction.
            </p>
          </div>
...
export default memo(VerifyTransaction);
